    ...
    <div className="flex flex-col items-center justify-center py-12 md:py-16 lg:py-24 w-full">
      <Container>
        <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
          <SectionBadge title="Product Portfolio" />
          ...
          <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
            ...
            In-depth insights into each product built to solve modern challenges
  ...
  return (
    ...
    >
      ...
      <div className="group-hover/feature:-translate-y-1 transform-gpu transition-all duration-300 flex flex-col w-full">
        ...
        <Link href={link} target="_blank" className="self-end px-10">
          <InteractiveHoverButton text="Learn More" className="w-44 mt-4" />
        </Link>
      </div>
    </div>
  );
