    ...
    return (
        <div className="flex flex-col items-center text-center w-full max-w-5xl my-24 mx-auto z-40 relative">
            ...
            <Container delay={0.1}>
                ...
                Streamline your workflows and unleash creativity with Troika Hub. From automation to portfolio management, our unified SaaS ecosystem empowers you to work smarter, innovate faster, and achieve more.
                </p>
            </Container> 
            <Container delay={0.2}>
